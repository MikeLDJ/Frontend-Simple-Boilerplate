...
gulp.task('copyFiles', function() {
  return gulp.src(['src/css/**/*', 'src/fonts/**/*', 'src/js/**/*', 'src/images/**/*', 'src/components/layout/**/*'], {
    base: 'src'
  }).pipe(gulp.dest('prod'));
});
...
gulp.task('copyDevFiles', ['sass'], function() {
  ...
  gulp.src('src/images/**/*').pipe(gulp.dest('dev/images'));
  gulp.src('src/fonts/**/*').pipe(gulp.dest('dev/fonts'));
});
...
gulp.task('default', ['clean', 'minCss', 'minJs', 'copyFiles'], function() {
